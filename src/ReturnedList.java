 ...
 * @author eve
 */
public class ReturnedList extends javax.swing.JPanel {

    /**
     * Creates new form returnedList
     */
    public ReturnedList() {
        initComponents();
        loadIssuedBooks();
      ...
      public void loadIssuedBooks() {
       issuedBooksDAO dao = new issuedBooksDAO();
        List<issuedBooks> IB = dao.getAllIssuedR();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Book's Title", "Borrower's Name", "Status", "Issued_Date", "Action_Time"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 500, 250));

        jLabel1.setFont(new java.awt.Font("Arial Black", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 102));
        jLabel1.setText("Returned List");
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 380));
